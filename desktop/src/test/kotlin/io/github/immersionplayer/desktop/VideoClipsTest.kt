...
class VideoClipsTest {
    ...
    @Test fun audioClipIsOpus() {
        ...
        assertTrue(VideoClips.audioClip(video!!, 60.0, 62.5, null, out))
    ...
    @Test fun screenshotIsSmallAvif() {
        ...
        assertTrue(VideoClips.screenshot(video!!, 61.0, 360, out))
    ...
    @Test fun animationIsAnimatedAvif() {
        ...
        assertTrue(VideoClips.animation(video!!, 60.0, 62.0, 360, out))
